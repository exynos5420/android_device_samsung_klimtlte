...
*/
    ...
    {11020, NULL, WAKE_PARTIAL},
    {11021, NULL, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_SIM_COUNT_MISMATCHED, responseVoid, WAKE_PARTIAL}, // 11058
    ...
    {RIL_UNSOL_SIM_ICCID_NOTI, responseVoid, WAKE_PARTIAL}, // 11066
